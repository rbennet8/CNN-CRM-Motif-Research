...
def tune_cnn(hp):    
    ...
    l1_reg_1 = hp.Choice('l1_1', values=[0.1, 0.01, 0.001, 0.0001, 0.00001])
    l2_reg_1 = hp.Choice('l2_1', values=[0.1, 0.01, 0.001, 0.0001, 0.00001])
    l1_reg_2 = hp.Choice('l1_2', values=[0.1, 0.01, 0.001, 0.0001, 0.00001])
    l2_reg_2 = hp.Choice('l2_2', values=[0.1, 0.01, 0.001, 0.0001, 0.00001])
    ...
    model.add(Conv2D(filters = filters_2, kernel_size = (10, 2), activation = 'relu'))
    ...
    model.add(BatchNormalization())
    model.add(Flatten())
    model.add(Dense(units = units, activation = 'relu', kernel_regularizer=regularizers.l1_l2(l1 = l1_reg_1, l2 = l2_reg_1)))
    model.add(Dense(1, activation = 'sigmoid', kernel_regularizer=regularizers.l1_l2(l1 = l1_reg_2, l2 = l2_reg_2)))
...
checkpoint_path = '/users/rbennet8/checkpoint-reg'
...
tuner = Hyperband(tune_cnn, max_epochs = 10, objective = 'val_accuracy', seed = 1, directory = 'Hyperband Reg Long', project_name = 'Tune Reg', overwrite = True)
